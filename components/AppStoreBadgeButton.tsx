...
const STORE_URLS = {
  apple: "https://apps.apple.com/br/app/cardtroca/id6779094214",
  google:
...
export function AppStoreBadgeButton({ store }: { store: "apple" | "google" }) {
  if (store === "apple") {
    return (
      <a
        ...
        className="flex-1 flex items-center gap-3 px-5 py-3 rounded-2xl bg-ds-surface border border-ds-border backdrop-blur-sm hover:border-ds-border-strong transition-colors"
      ...
      >
        ...
        <div className="text-left">
          <p className="text-ds-text-secondary text-[10px] font-medium leading-none mb-0.5">Disponível na</p>
  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        <p className="text-ds-text-secondary text-[10px] font-medium leading-none mb-0.5">Disponível no</p>
