...
export function AppStoreBadgeButton({ store }: { store: "apple" | "google" }) {
    ...
    return (
      ...
      >
        ...
        <div className="text-left">
          <p className="text-white/70 text-[10px] font-medium leading-none mb-0.5">Disponível na</p>
  ...
  return (
    ...
    >
      ...
      <div className="text-left">
        <p className="text-white/70 text-[10px] font-medium leading-none mb-0.5">Disponível no</p>
